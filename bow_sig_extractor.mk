...
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)/home/stylix/local/lib $(LibraryPathSwitch)../lib/ins/$(ConfigurationName) $(LibraryPathSwitch)../lib/orb/$(ConfigurationName) $(LibraryPathSwitch)../lib/sifthesaff/$(ConfigurationName) $(LibraryPathSwitch)../lib/alphautils/$(ConfigurationName) $(LibraryPathSwitch)../lib/ransac/$(ConfigurationName) 
...
$(IntermediateDirectory)/bow_sig_extractor.cpp$(ObjectSuffix): bow_sig_extractor.cpp $(IntermediateDirectory)/bow_sig_extractor.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/stylix/Dropbox/MyDocument/SokendaiCourse/Researches/Workspace/code/ins_online/bow_sig_extractor.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/bow_sig_extractor.cpp$(ObjectSuffix) $(IncludePath)
